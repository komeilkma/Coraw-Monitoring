...
<body>
	...
	<div class="navigation">
		...
		<div class="navigation-menu-body">
			<ul id="navigationDashboards" class="navigation-active">
				...
				<li>
					<a class="active" href="Passengersgeneral" >آمار های مسافری </a>
				</li>
					<li>
	...
	<div class="header">
		...
		<div class="header-body">
			...
			<div class="header-body-left">
				...
				<h3 class="page-title"> آمار های مسافری </h3>

				<!-- begin::breadcrumb -->
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="#" onclick="alertsweer()">داشبورد</a></li>
						<li class="breadcrumb-item active" aria-current="page"> آمار های مسافری</li>
					</ol>
				</nav>
				<!-- end::breadcrumb -->
	...
	<div class="form-group">
		...
		<div class="col-md-6">
		<div class="card">
		<div class="card-header">مسافر کل سامانه به تفکیک نواحی</div>
			<div class="card-body">
				<div class="morris-chart" id="line-chart15" style="height: 400px;"></div>
			</div>
		</div>
		</div>
		<div class="col-md-6">
		<div class="card">
		<div class="card-header">مسافر کل سامانه</div>
			<div class="card-body">
				<div class="morris-chart" id="line-chart" style="height: 400px;"></div>
			</div>
		</div>
		</div>
