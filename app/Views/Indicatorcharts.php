...
<head>
	...
	<!-- Morris -->
	<link rel="stylesheet" href="vendors/charts/morris/morris.css" type="text/css">
...
<body>
		...
		<div class="navigation-menu-body">
			<ul id="navigationDashboards" class="navigation-active">
				...
				<li >
					...
					<li>
					<a class="active" href="Indicatorcharts" >روند سالانه</a>
				</li>
					<li>
					<a href="Indicatorcompare" >مقایسه ها</a>
				</li>
	...
	<div class="header">
		...
		<div class="header-body">
			...
			<div class="header-body-left">
				...
				<h3 class="page-title">  روند سالانه شاخص های کلیدی</h3>

				<!-- begin::breadcrumb -->
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="#" onclick="alertsweer()">داشبورد</a></li>
						<li class="breadcrumb-item active" aria-current="page">  روند سالانه شاخص های کلیدی</li>
					</ol>
				</nav>
				<!-- end::breadcrumb -->
	...
	<div class="form-group">
		...
		<div class="col-md-3">
		<div class="card">
		<div class="card-header">تعداد مسافر</div>
			<div class="card-body">
				<div class="morris-chart" id="line-chart" style="height: 150px;"></div>
			</div>
		</div>
		</div>
		...
		<div class="col-md-3">
		<div class="card">
		<div class="card-header">صندلی ایجادی</div>
			<div class="card-body">
				<div class="morris-chart" id="line-chart2" style="height: 150px;"></div>
			</div>
		</div>
		</div>
		...
		<div class="col-md-3">
		<div class="card">
		<div class="card-header">میانگین ضریب اشغال سالانه</div>
			<div class="card-body">
				<div class="morris-chart" id="line-chart3" style="height: 150px;"></div>
			</div>
		</div>
		</div>
		...
		<div class="col-md-3">
		<div class="card">
		<div class="card-header">مسافر کیلومتر</div>
			<div class="card-body">
				<div class="morris-chart" id="line-chart4" style="height: 150px;"></div>
			</div>
		</div>
		</div>
		...
		<div class="col-md-3">
		<div class="card">
		<div class="card-header">میانگین تاخیر در مقصد</div>
			<div class="card-body">
				<div class="morris-chart" id="line-chart5" style="height: 150px;"></div>
			</div>
		</div>
		</div>
		...
		<div class="col-md-3">
		<div class="card">
		<div class="card-header">تعداد شکایات</div>
			<div class="card-body">
				<div class="morris-chart" id="line-chart6" style="height: 150px;"></div>
			</div>
		</div>
		</div>
		...
		<div class="col-md-3">
		<div class="card">
		<div class="card-header">تعداد سیر قطار سالانه</div>
			<div class="card-body">
				<div class="morris-chart" id="line-chart7" style="height: 150px;"></div>
			</div>
		</div>
		</div>
		...
		<div class="col-md-3">
		<div class="card">
		<div class="card-header">جمع درآمد سامانه های فروش</div>
			<div class="card-body">
				<div class="morris-chart" id="line-chart8" style="height: 150px;"></div>
			</div>
		</div>
		</div>
		...
		<div class="col-md-3">
		<div class="card">
		<div class="card-header">مجموع هزینه</div>
			<div class="card-body">
				<div class="morris-chart" id="line-chart9" style="height: 150px;"></div>
			</div>
		</div>
		</div>
		...
		<div class="col-md-3">
		<div class="card">
		<div class="card-header">مجموع درآمد</div>
			<div class="card-body">
				<div class="morris-chart" id="line-chart10" style="height: 150px;"></div>
			</div>
		</div>
		</div>
		...
		<div class="col-md-3">
		<div class="card">
		<div class="card-header">مجموع منافع اقتصادی</div>
			<div class="card-body">
				<div class="morris-chart" id="line-chart11" style="height: 150px;"></div>
			</div>
		</div>
		</div>
		...
		<div class="col-md-3">
		<div class="card">
		<div class="card-header">مجموع یارانه</div>
			<div class="card-body">
				<div class="morris-chart" id="line-chart12" style="height: 150px;"></div>
			</div>
		</div>
		</div>
	...
	<!-- Morris -->
	<script src="vendors/charts/morris/raphael-2.1.4.min.js"></script>
	<script src="vendors/charts/morris/morris.min.js"></script>
	<script src="assets/js/examples/charts/morris.js"></script>
