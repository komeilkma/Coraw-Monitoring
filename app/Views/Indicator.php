...
<body>
	...
	<div class="navigation">
		...
		<div class="navigation-menu-body">
			<ul id="navigationDashboards" class="navigation-active">
				...
				<li >
					<a class="active" href="Indicator" >شاخص های کلیدی</a>
				</li>
					<li>
	...
	<div class="header">
		...
		<div class="header-body">
			...
			<div class="header-body-left">
				...
				<h3 class="page-title"> شاخص های کلیدی</h3>

				<!-- begin::breadcrumb -->
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="#" onclick="alertsweer()">داشبورد</a></li>
						<li class="breadcrumb-item active" aria-current="page"> شاخص های کلیدی</li>
					</ol>
				</nav>
				<!-- end::breadcrumb -->
	...
	<div class="form-group">
		...
		<div class="row">
			...
			<div class="col-md-3">
					<div class="card m-b-30 bg-primary-gradient">
					<div class="card-body text-white">
						<div class="text-center">
							<div class="font-size-35 p-t-15 line-height-46">5,3<span class="font-size-20">میلیون نفر</span></div>
			...
			<div class="col-md-3">
					...
					<div class="card-body text-white">
						<div class="text-center">
							<div class="font-size-35 p-t-15 line-height-46">8,4 <span class="font-size-20">میلیون نفر</span></div>
							<p class="opacity-7 p-t-10">
							صندلی ایجادی
							</p>
						</div>
			...
			<div class="col-md-3">
					...
					<div class="card-body text-white">
						<div class="text-center">
							<div class="font-size-35 p-t-15 line-height-46">58.7 %<span class="font-size-20"></span></div>
							<p class="opacity-7 p-t-10">
								میانگین ضزیب اشغال
							</p>
						</div>
			...
			<div class="col-md-3">
					...
					<div class="card-body text-white">
						<div class="text-center">
							<div class="font-size-35 p-t-15 line-height-46">0.56<span class="font-size-20">میلیارد کیلومتر</span></div>
							<p class="opacity-7 p-t-10">
								مسافر کیلومتر
							</p>
						</div>
			...
			<div class="col-md-3">
					...
					<div class="card-body text-white">
						<div class="text-center">
							<div class="font-size-35 p-t-15 line-height-46">4.8 <span class="font-size-20">دقیقه</span></div>
							<p class="opacity-7 p-t-10">
								میانگین تاخیر در مقصد
							</p>
						</div>
					</div>
				</div>
			...
			<div class="col-md-3">
					...
					<div class="card-body text-white">
						<div class="text-center">
							<div class="font-size-35 p-t-15 line-height-46">1.114<span class="font-size-20"></span></div>
							<p class="opacity-7 p-t-10">
								تعداد شکایت
							</p>
						</div>
			...
			<div class="col-md-3">
					...
					<div class="card-body text-white">
						<div class="text-center">
							<div class="font-size-35 p-t-15 line-height-46">23.88<span class="font-size-20">هزار</span></div>
							<p class="opacity-7 p-t-10">
								تعداد سیر سالانه
							</p>
						</div>
			...
			<div class="col-md-3">
					...
					<div class="card-body text-white">
						<div class="text-center">
							<div class="font-size-35 p-t-15 line-height-46">18<span class="font-size-20"></span></div>
							<p class="opacity-7 p-t-10">
								تعداد مسیر ها
							</p>
						</div>
			...
			<div class="col-md-3">
					...
					<div class="card-body text-white">
						<div class="text-center">
							<div class="font-size-35 p-t-15 line-height-46">134<span class="font-size-20"></span></div>
							<p class="opacity-7 p-t-10">
								تعداد واگن در سیر روزانه
							</p>
						</div>
					</div>
				</div>
			...
			<div class="col-md-3">
					...
					<div class="card-body text-white">
						<div class="text-center">
							<div class="font-size-35 p-t-15 line-height-46">104 <span class="font-size-20"></span></div>
							<p class="opacity-7 p-t-10">
								تعداد ایستگاه ها
							</p>
						</div>
			...
			<div class="col-md-3">
					...
					<div class="card-body text-white">
						<div class="text-center">
							<div class="font-size-35 p-t-15 line-height-46">18.7 <span class="font-size-20">میلیارد تومان</span></div>
							<p class="opacity-7 p-t-10">
								جمع کل درآمد سامانه های فروش
							</p>
						</div>
					</div>
				</div>
			...
			<div class="col-md-3">
					...
					<div class="card-body text-white">
						<div class="text-center">
							<div class="font-size-35 p-t-15 line-height-46">151<span class="font-size-20">میلیارد تومان</span></div>
							<p class="opacity-7 p-t-10">
								مجموع هزینه 
							</p>
						</div>
			...
			<div class="col-md-3">
					...
					<div class="card-body text-white">
						<div class="text-center">
							<div class="font-size-35 p-t-15 line-height-46">132<span class="font-size-20">میلیارد تومان</span></div>
							<p class="opacity-7 p-t-10">
								مجموع یارانه
							</p>
						</div>
			...
			<div class="col-md-3">
					...
					<div class="card-body text-white">
						<div class="text-center">
							<div class="font-size-35 p-t-15 line-height-46">361 <span class="font-size-20">میلیارد تومان</span></div>
							<p class="opacity-7 p-t-10">
								مجموع منافع اقتصادی
							</p>
						</div>
